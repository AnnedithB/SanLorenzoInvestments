                ...
                <div className="grid grid-cols-12 items-center gap-3">
                    <div className="col-span-6 md:col-span-12">
                        ...
                        before:w-[60px] before:h-[1px] before:bg-[#c0b596] md:before:hidden">Why Choose Terra Luxe</h2>
                            ...
                            <p className="text-[#666] text-[15px] leading-[28px] mb-[30px]">Every piece is meticulously crafted from premium Teak wood, selected for its natural beauty, durability, and resistance to demanding climate conditions nationwide. Our upholstery and fabrics draw inspiration from luxury yacht interiors, engineered to withstand sun, salt, and moisture while maintaining their luxurious appearance. These sophisticated, timeless designs complement both contemporary and classic architectural styles, creating spaces that feel both current and enduring.</p>
