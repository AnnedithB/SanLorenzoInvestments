    ...
    return (
        ...
        <section className="hero relative h-[95vh] lg:h-[500px] col:h-[450px] overflow-hidden z-20 flex flex-col justify-center">
            ...
            <div className="slide-inner slide-bg-image h-[95vh] lg:h-[500px] col:h-[450px] relative">
                <div 
                    className="absolute inset-0 bg-[url('/images/brands/3.jpeg')] bg-cover bg-center bg-no-repeat"
                >
                </div>
                ...
                <div className="relative z-20 h-full flex items-center justify-center">
                    <div className="wraper w-full">
                        <div className="slide-caption max-w-[700px] mx-auto text-center">
                            <p className="text-white text-[20px] font-light col:text-[18px]">24/7 unmanned convenience stores for residential complexes</p>
                            <h2 className="text-white text-[60px] leading-[90px] lg:text-[42px] lg:leading-[56px] 
                     col:text-[25px] col:leading-[35px] font-normal my-[33px] md:my-[20px]"><span>Convenience at Your </span> <br /> <span>Doorstep, Anytime</span></h2>
                            
                            <div className="btns flex justify-center">
                                <div className="btn-style">
                                    <Link href="/contact" className="bg-[#c0b596] relative cursor-pointer text-[16px]
                        ...
                        col:mb-[5px] col:mt-[15px] col:text-[15px] col:px-[18px] col:py-[8px]">Request Installation Consultation</Link>
                                </div>
                            </div>
